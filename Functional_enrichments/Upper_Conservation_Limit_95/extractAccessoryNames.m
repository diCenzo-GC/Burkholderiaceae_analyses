%%
% Load the data
data = table2cell(readtable('../nucleotidePangenomes/GenePresence/Burkholderia_allGenus_chromosome.csv'));

% Find accessory genes
cutoff = ((size(data, 2) - 14) * 0.95);
pos = {};
for n = 1:size(data, 1)
...
%%
% Load the data
data = table2cell(readtable('../nucleotidePangenomes/GenePresence/Burkholderia_allGenus_chromid.csv'));
...
%%
% Load the data
data = table2cell(readtable('../nucleotidePangenomes/GenePresence/Burkholderia_BCC_chromosome.csv'));
...
%%
% Load the data
data = table2cell(readtable('../nucleotidePangenomes/GenePresence/Burkholderia_BCC_chromid.csv'));
...
%%
% Load the data
data = table2cell(readtable('../nucleotidePangenomes/GenePresence/Burkholderia_BCC_megaplasmid.csv'));
...
%%
% Load the data
data = table2cell(readtable('../nucleotidePangenomes/GenePresence/Burkholderia_nonBCC_chromosome.csv'));
...
%%
% Load the data
data = table2cell(readtable('../nucleotidePangenomes/GenePresence/Burkholderia_nonBCC_chromid.csv'));
...
%%
% Load the data
data = table2cell(readtable('../nucleotidePangenomes/GenePresence/Paraburkholderia_allGenus_chromosome.csv'));
...
%%
% Load the data
data = table2cell(readtable('../nucleotidePangenomes/GenePresence/Paraburkholderia_allGenus_chromid.csv'));
...
%%
% Load the data
data = table2cell(readtable('../nucleotidePangenomes/GenePresence/Paraburkholderia_woMega_chromosome.csv'));
...
%%
% Load the data
data = table2cell(readtable('../nucleotidePangenomes/GenePresence/Paraburkholderia_woMega_chromid.csv'));
...
%%
% Load the data
data = table2cell(readtable('../nucleotidePangenomes/GenePresence/Paraburkholderia_wMega_chromosome.csv'));
...
%%
% Load the data
data = table2cell(readtable('../nucleotidePangenomes/GenePresence/Paraburkholderia_wMega_chromid.csv'));
...
%%
% Load the data
data = table2cell(readtable('../nucleotidePangenomes/GenePresence/Paraburkholderia_wMega_megaplasmid.csv'));
...
%%
% Load the data
data = table2cell(readtable('../nucleotidePangenomes/GenePresence/Cupriavidus_allGenus_chromosome.csv'));
...
%%
% Load the data
data = table2cell(readtable('../nucleotidePangenomes/GenePresence/Cupriavidus_allGenus_chromid.csv'));
...
%%
% Load the data
data = table2cell(readtable('../nucleotidePangenomes/GenePresence/Ralstonia_allGenus_chromosome.csv'));
...
%%
% Load the data
data = table2cell(readtable('../nucleotidePangenomes/GenePresence/Ralstonia_allGenus_chromid.csv'));
...
%%
% Load the data
data = table2cell(readtable('../nucleotidePangenomes/GenePresence/Pandoraea_allGenus_chromosome.csv'));
...
%%
% Load the data
data = table2cell(readtable('../nucleotidePangenomes/GenePresence/Polynucleobacter_allGenus_chromosome.csv'));
